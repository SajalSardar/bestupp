  ...
  <body>
    ...
    <div class="sl-logo">
      <a href="{{ url('/') }}" target="_blank">
        <img src="{{ asset('frontend/images/logo.png') }}" width="100" alt="{{ config('app.name') }}">
      </a>
    </div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('dashboard.banner.index') }}" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">abc</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="" class="nav-link">Add Banner</a></li>
          <li class="nav-item"><a href="" class="nav-link">All Banner</a></li>
        </ul>
